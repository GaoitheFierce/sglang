...
class RuyiQwen2DecoderLayer(nn.Module):
    def __init__(
        ...
        self.self_attn = RuyiQwen2Attention(
...
class RuyiQwen2Model(nn.Module):
    def __init__(
        self,
        config: RuyiQwen2Config,
        quant_config: Optional[QuantizationConfig] = None,
        prefix: str = "",
        decoder_layer_type: type[nn.Module] = RuyiQwen2DecoderLayer,
        alt_stream: Optional[torch.cuda.Stream] = None,
    ) -> None:
        super().__init__()
        ...
        decoder_layer_type = decoder_layer_type or RuyiQwen2DecoderLayer
...
class RuyiQwen2ForCausalLM(nn.Module):
...
EntryClass = RuyiQwen2ForCausalLM
